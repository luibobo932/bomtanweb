  ...
  return (
    <div className="flex items-center gap-2">
      ...
      <a
        ...
        target="_blank"
        rel="noreferrer"
        className="flex h-8 w-8 items-center justify-center rounded-[8px] border border-[#2e2e28] bg-[#141414] text-zinc-400 transition hover:border-[var(--brand)] hover:text-white"
