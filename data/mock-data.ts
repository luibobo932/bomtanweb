...
export const videos: VideoItem[] = [
  {
    id: "vid-tiktok-demo",
    title: "DEMO: Video TikTok nhúng trực tiếp từ link",
    slug: "demo-tiktok-embed",
    districtTag: "Quận 3",
    streetTag: "TikTok Embed",
    priceTag: "12-15 tỷ",
    houseTypeTag: "Hẻm xe hơi",
    reviewerProfileId: "minh-anh",
    reviewerSlug: "minh-anh",
    reviewerName: "Trần Minh Anh",
    summary: "Video này được nhúng trực tiếp từ một đường link TikTok công khai để kiểm chứng tính năng phát clip TikTok trên web.",
    durationSeconds: 30,
  ...
  {
    id: "vid-001",
    title: "Nhà phố Quận 3 hẻm xe hơi 14.8 tỷ - pháp lý đẹp",
    ...
    thumbnailUrl: "https://images.unsplash.com/photo-1460317442991-0ec209397118?auto=format&fit=crop&w=900&q=80",
    videoSourceType: "cdn",
    videoUrl: "/videos/41t-nguyen-tri-phuong-q10.mp4",
    cta: "Xem nhà",
